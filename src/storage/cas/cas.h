...
public:
    ...
    std::string compute_hash(const bsoncxx::document::view& geometry,
    ...
    std::vector<std::unique_ptr<BPO>> find_in_bbox(double min_lon, double min_lat, double max_lon,
                                                   double max_lat);
...
private:
    ...
    std::string serialize_for_hashing(const bsoncxx::document::view& geometry,
                                      const bsoncxx::document::view& attributes);
};
